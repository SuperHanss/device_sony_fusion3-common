...
package org.cyanogenmod.doze.fusion3;
...
public abstract class Fusion3Sensor {

    private static final String TAG = "Fusion3Sensor";
    ...
    public Fusion3Sensor(Context context, int type) {
        mContext = context;
        mType = type;
